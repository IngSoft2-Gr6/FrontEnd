...
import { Typography, Paper, Grid,Avatar, Button, Modal,Box} from "@mui/material";
		...
		>
			...
			{parkings.map((parking) =>(
				...
				<Marker position={{lat:parking.coords[0], lng:parking.coords[1]}}>
					<Popup>
						<Paper elevation={12} sx={{ margin: "0px", padding: "1rem", borderRadius: "1rem" ,overflow:"auto", height:"400px"}} >
							<Grid container spacing="15" width="100%">
								<Grid item xs={12}>
									<Grid container spacing="50">
										<Grid item lg={3} md={4} sm={4} xs={12}>
											<Avatar style={{  top: "50%" ,left: "50%", width:"50px", height:"50px"}} >{parking.name.charAt(0)} </Avatar>
										</Grid>
								...
								<Grid item xs={12}>
									<Grid container spacing="3">
										<Grid item lg={12} md={12} sm={12} xs={12}>
											<Button variant="outlined" onClick={() => navigate("#rating")}>Reservar</Button>
										</Grid>
									</Grid>
								</Grid>
								...
								<Grid item xs={12}>
									<Grid container spacing="3">
										<Grid item lg={12} md={12} sm={12} xs={12}>
											<Button variant="outlined" onClick={() => navigate("#rating")}>Calificar parqueadero</Button>
										</Grid>
									</Grid>
								</Grid>
